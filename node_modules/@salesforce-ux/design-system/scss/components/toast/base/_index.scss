...
.slds-notify--toast {
  ...
  padding-top: var(--slds-c-toast-spacing-block-start, var(--slds-c-toast-spacing-blockstart, var(--sds-c-toast-spacing-block-start, $spacing-small)));
  padding-right: var(--slds-c-toast-spacing-inline-end, var(--slds-c-toast-spacing-inlineend, var(--sds-c-toast-spacing-inline-end, $spacing-xx-large)));
  padding-bottom: var(--slds-c-toast-spacing-block-end, var(--slds-c-toast-spacing-blockend, var(--sds-c-toast-spacing-block-end, $spacing-small)));
  padding-left: var(--slds-c-toast-spacing-inline-start, var(--slds-c-toast-spacing-inlinestart, var(--sds-c-toast-spacing-inline-start, $spacing-large)));
  min-width: var(--slds-c-toast-sizing-min-width, var(--slds-c-toast-sizing-width-min, var(--sds-c-toast-sizing-min-width, rem(480px))));
  text-align: left;
