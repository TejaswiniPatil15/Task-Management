...
.slds-checkbox_toggle [type="checkbox"]:focus + .slds-checkbox_faux_container .slds-checkbox_faux {
  ...
  --slds-c-checkbox-toggle-color-background: var(
    ...
    var(--sds-c-checkbox-toggle-color-background-focus, var(--slds-g-color-neutral-base-50, #939393))
  );
  /*! @css-var-fallback box-shadow */
  --slds-c-checkbox-toggle-shadow: var(
    --slds-c-checkbox-toggle-shadow-focus,
    var(--sds-c-checkbox-toggle-shadow-focus, var(--slds-g-shadow-outset-focus-1, 0 0 3px #0176d3))
  );
}
...
.slds-checkbox_toggle [type="checkbox"]:checked + .slds-checkbox_faux_container .slds-checkbox_faux {
  ...
  --slds-c-checkbox-toggle-color-border: var(
    ...
    var(--sds-c-checkbox-toggle-color-border-checked, #0176d3)
  );
  /*! @css-var-fallback background-color */
  --slds-c-checkbox-toggle-color-background: var(
    --slds-c-checkbox-toggle-color-background-checked,
    var(--sds-c-checkbox-toggle-color-background-checked, #0176d3)
  );
}
...
.slds-checkbox_toggle [type="checkbox"]:checked + .slds-checkbox_faux_container .slds-checkbox_faux:focus {
  /*! @css-var-fallback background-color */
  --slds-c-checkbox-toggle-color-background: var(
    --slds-c-checkbox-toggle-color-background-checked-hover,
    var(--sds-c-checkbox-toggle-color-background-checked-hover, #014486)
  );
}
