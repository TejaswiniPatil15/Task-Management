...
[kx-scope="button"][kx-type="underline"]:after {
  ...
  height: 0.0625rem;
  width: calc(
    100% - var(--slds-c-button-spacing-inline-start, var(--slds-c-button-spacing-inlinestart, 0rem)) -
      var(--slds-c-button-spacing-inline-end, var(--slds-c-button-spacing-inlineend, 0rem))
  );
