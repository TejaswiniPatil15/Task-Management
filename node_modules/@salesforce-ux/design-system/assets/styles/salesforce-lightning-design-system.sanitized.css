...
@layer defaults{
  :where(html){
    ...
    --slds-g-shadow-1:0px 2px 2px 0px #0000001A;
    --sds-g-shadow-2:var(--slds-g-shadow-2);
    --slds-g-shadow-2:0px 2px 3px 0px #00000027;
    --sds-g-shadow-3:var(--slds-g-shadow-3);
    --slds-g-shadow-3:0px 2px 4px 0px #00000027;
    --sds-g-shadow-4:var(--slds-g-shadow-4);
    --slds-g-shadow-4:0px 2px 5px 0px #00000027;
    ...
    --slds-g-color-palette-neutral-0:#000;
    ...
    --slds-g-color-palette-neutral-30:#444;
    ...
    --slds-g-color-palette-neutral-100:#fff;
    ...
    --slds-g-color-error-base-95:#fef1ee;
    ...
    --slds-g-color-error-base-65:#fe7765;
    ...
    --slds-g-color-error-base-15:#4a0c04;
    ...
    --slds-g-color-warning-base-95:#fff1ea;
    ...
    --slds-g-color-warning-base-65:#f38303;
    ...
    --slds-g-color-warning-base-15:#371e03;
    ...
    --slds-g-color-success-base-95:#ebf7e6;
    ...
    --slds-g-color-success-base-65:#41b658;
    ...
    --slds-g-color-surface-container-1:#fff;
    ...
    --slds-g-color-on-surface-1:#757575;
    ...
    --slds-g-color-accent-1:var(--lwc-brandPrimary, var(--slds-g-color-brand-base-60));
    --sds-g-color-accent-2:var(--slds-g-color-accent-2);
    --slds-g-color-accent-2:var(--lwc-brandPrimaryActive, var(--slds-g-color-brand-base-50));
    --sds-g-color-accent-3:var(--slds-g-color-accent-3);
    --slds-g-color-accent-3:#0b5cab;
    --sds-g-color-accent-container-1:var(--slds-g-color-accent-container-1);
    --slds-g-color-accent-container-1:var(--lwc-brandAccessible, var(--slds-g-color-brand-base-50));
    --sds-g-color-accent-container-2:var(--slds-g-color-accent-container-2);
    --slds-g-color-accent-container-2:var(--lwc-brandAccessibleActive, var(--slds-g-color-brand-base-40));
    --sds-g-color-accent-container-3:var(--slds-g-color-accent-container-3);
    --slds-g-color-accent-container-3:#014486;
    --sds-g-color-on-accent-1:var(--slds-g-color-on-accent-1);
    --slds-g-color-on-accent-1:var(--slds-g-color-brand-base-100);
    --sds-g-color-on-accent-2:var(--slds-g-color-on-accent-2);
    --slds-g-color-on-accent-2:var(--slds-g-color-brand-base-100);
    --sds-g-color-on-accent-3:var(--slds-g-color-on-accent-3);
    --slds-g-color-on-accent-3:var(--slds-g-color-brand-base-100);
    ...
    --slds-g-color-warning-container-1:#dd7a01;
    --sds-g-color-on-warning-1:var(--slds-g-color-on-warning-1);
    --slds-g-color-on-warning-1:#181818;
    ...
    --slds-g-shadow-inline-start-1:-2px 0px 2px 0px #0000001A;
    ...
    --slds-g-shadow-block-start-2:0px -2px 3px 0px #00000027;
    --sds-g-shadow-inline-end-2:var(--slds-g-shadow-inline-end-2);
    --slds-g-shadow-inline-end-2:2px 0px 3px 0px #00000027;
    ...
    --slds-g-shadow-inline-start-2:-2px 0px 3px 0px #00000027;
    ...
    --slds-g-shadow-block-start-3:0px -2px 4px 0px #00000027;
    --sds-g-shadow-inline-end-3:var(--slds-g-shadow-inline-end-3);
    --slds-g-shadow-inline-end-3:2px 0px 4px 0px #00000027;
    ...
    --slds-g-shadow-inline-start-3:-2px 0px 4px 0px #00000027;
    ...
    --slds-g-shadow-block-start-4:0px -2px 4px 0px #00000027;
    --sds-g-shadow-inline-end-4:var(--slds-g-shadow-inline-end-4);
    --slds-g-shadow-inline-end-4:2px 0px 4px 0px #00000027;
    ...
    --slds-g-shadow-inline-start-4:-2px 0px 4px 0px #00000027;
    ...
    --slds-g-shadow-outline-focus-1:0px 0px 0px 2px var(--slds-g-color-brand-base-40);
    --sds-g-shadow-outset-focus-1:var(--slds-g-shadow-outset-focus-1);
    --slds-g-shadow-outset-focus-1:0px 0px 0px 2px var(--slds-g-color-neutral-base-100), 0px 0px 0px 4px var(--slds-g-color-brand-base-40);
    --sds-g-shadow-inset-focus-1:var(--slds-g-shadow-inset-focus-1);
    --slds-g-shadow-inset-focus-1:0px 0px 0px 2px var(--slds-g-color-brand-base-40) inset;
    --sds-g-shadow-inset-inverse-focus-1:var(--slds-g-shadow-inset-inverse-focus-1);
    --slds-g-shadow-inset-inverse-focus-1:0px 0px 0px 2px var(--slds-g-color-brand-base-40) inset, 0px 0px 0px 4px var(--slds-g-color-neutral-base-100) inset;
    ...
    --slds-g-color-surface-container-inverse-2:#001639;
    --sds-g-color-on-surface-inverse-1:var(--slds-g-color-on-surface-inverse-1);
    --slds-g-color-on-surface-inverse-1:#fff;
    --sds-g-color-on-surface-inverse-2:var(--slds-g-color-on-surface-inverse-2);
    --slds-g-color-on-surface-inverse-2:#aeaeae;
    --sds-g-color-border-inverse-1:var(--slds-g-color-border-inverse-1);
    --slds-g-color-border-inverse-1:#f3f3f3;
    --sds-g-color-border-inverse-2:var(--slds-g-color-border-inverse-2);
    --slds-g-color-border-inverse-2:#032d60;
    --sds-g-color-accent-light-1:var(--slds-g-color-accent-light-1);
    --slds-g-color-accent-light-1:var(--lwc-brandLight, var(--slds-g-color-brand-base-95));
    --sds-g-color-accent-light-2:var(--slds-g-color-accent-light-2);
    --slds-g-color-accent-light-2:var(--lwc-brandLightActive, var(--slds-g-color-brand-base-90));
    --sds-g-color-accent-dark-1:var(--slds-g-color-accent-dark-1);
    --slds-g-color-accent-dark-1:var(--lwc-brandDark, var(--slds-g-color-brand-base-20));
    --sds-g-color-accent-dark-2:var(--slds-g-color-accent-dark-2);
    --slds-g-color-accent-dark-2:var(--lwc-brandDarkActive, var(--slds-g-color-brand-base-10));
  }
}
@layer shared{
  :where(html){
    --sds-s-table-color:var(--slds-s-table-color);
    --slds-s-table-color:var(--slds-g-color-on-surface-3);
    ...
    --slds-s-table-header-color-background-hover:var(--slds-g-color-surface-container-1);
    ...
    --slds-s-table-header-color:var(--slds-g-color-on-surface-2);
    --sds-s-table-header-font-weight:var(--slds-s-table-header-font-weight);
    --slds-s-table-header-font-weight:var(--slds-g-font-weight-7);
    --sds-s-table-resize-color:var(--slds-s-table-resize-color);
    --slds-s-table-resize-color:var(--slds-g-color-neutral-base-70);
    --sds-s-table-resize-color-active:var(--slds-s-table-resize-color-active);
    --slds-s-table-resize-color-active:var(--slds-g-color-accent-2);
    --sds-s-table-row-color-background-selected:var(--slds-s-table-row-color-background-selected);
    --slds-s-table-row-color-background-selected:var(--slds-g-color-surface-container-2);
    --sds-s-table-row-color-border-selected-hover:var(--slds-s-table-row-color-border-selected-hover);
    --slds-s-table-row-color-border-selected-hover:var(--slds-g-color-border-1);
    --sds-s-table-cell-shadow-selected:var(--slds-s-table-cell-shadow-selected);
    --slds-s-table-cell-shadow-selected:var(--slds-g-color-accent-2) 0 0 0 1px inset;
    --sds-s-pill-color-background-hover:var(--slds-s-pill-color-background-hover);
    --slds-s-pill-color-background-hover:var(--slds-g-color-surface-container-2);
    ...
    --slds-s-pageheader-row-color-background:var(--slds-g-color-surface-container-1);
    ...
    --slds-s-navigation-color-background-hover:var(--slds-g-color-surface-container-3);
    --sds-s-navigation-radius-border:var(--slds-s-navigation-radius-border);
    --slds-s-navigation-radius-border:var(--slds-g-radius-border-2);
    --sds-s-navigation-color:var(--slds-s-navigation-color);
    --slds-s-navigation-color:var(--slds-g-color-on-surface-2);
    --sds-s-navigation-color-active:var(--slds-s-navigation-color-active);
    --slds-s-navigation-color-active:var(--slds-g-color-on-surface-2);
    --sds-s-navigation-color-hover:var(--slds-s-navigation-color-hover);
    --slds-s-navigation-color-hover:var(--slds-g-color-on-surface-2);
    --sds-s-navigation-color-border:var(--slds-s-navigation-color-border);
    --slds-s-navigation-color-border:var(--slds-g-color-border-2);
    --sds-s-navigation-color-border-hover:var(--slds-s-navigation-color-border-hover);
    --slds-s-navigation-color-border-hover:var(--slds-g-color-accent-2);
    --sds-s-navigation-sizing-border-hover:var(--slds-s-navigation-sizing-border-hover);
    --slds-s-navigation-sizing-border-hover:2px;
    ...
    --slds-s-navigation-font-weight:normal;
    --sds-s-navigation-font-weight-active:var(--slds-s-navigation-font-weight-active);
    --slds-s-navigation-font-weight-active:700;
    --sds-s-menu-item-color-background-active:var(--slds-s-menu-item-color-background-active);
    --slds-s-menu-item-color-background-active:var(--slds-g-color-surface-container-2);
    --sds-s-menu-item-color-active:var(--slds-s-menu-item-color-active);
    --slds-s-menu-item-color-active:var(--slds-g-color-accent-2);
    --sds-s-link-color:var(--slds-s-link-color);
    --slds-s-link-color:var(--lwc-brandTextLink, var(--slds-g-color-accent-2));
    --sds-s-link-color-hover:var(--slds-s-link-color-hover);
    --slds-s-link-color-hover:var(--lwc-brandTextLinkActive, var(--slds-g-color-accent-3));
    --sds-s-link-color-focus:var(--slds-s-link-color-focus);
    --slds-s-link-color-focus:var(--lwc-brandTextLinkActive, var(--slds-g-color-accent-3));
    --sds-s-link-color-active:var(--slds-s-link-color-active);
    --slds-s-link-color-active:var(--lwc-brandTextLinkActive, var(--slds-g-color-accent-3));
    --sds-s-link-outline-color:var(--slds-s-link-outline-color);
    --slds-s-link-outline-color:var(--slds-g-color-brand-base-40);
    --sds-s-label-spacing:var(--slds-s-label-spacing);
    --slds-s-label-spacing:var(--slds-g-spacing-1);
    --sds-s-label-font-size:var(--slds-s-label-font-size);
    --slds-s-label-font-size:var(--slds-g-font-scale-neg-1);
    --sds-s-label-color:var(--slds-s-label-color);
    --slds-s-label-color:var(--slds-g-color-on-surface-2);
    --sds-s-label-sizing-gap:var(--slds-s-label-sizing-gap);
    --slds-s-label-sizing-gap:var(--slds-g-spacing-1);
    ...
    --slds-s-input-color-background-disabled:var(--slds-g-color-surface-container-3);
    --sds-s-input-color-background-invalid:var(--slds-s-input-color-background-invalid);
    --slds-s-input-color-background-invalid:var(--slds-g-color-surface-container-1);
    ...
    --slds-s-input-color-invalid:var(--slds-g-color-on-surface-2);
    --sds-s-input-shadow-focus:var(--slds-s-input-shadow-focus);
    --slds-s-input-shadow-focus:0 0 3px var(--sds-g-color-accent-2);
    --sds-s-input-shadow-invalid:var(--slds-s-input-shadow-invalid);
    --slds-s-input-shadow-invalid:inset 0 0 0 1px var(--sds-g-color-error-1);
    --sds-s-input-color-border-focus:var(--slds-s-input-color-border-focus);
    --slds-s-input-color-border-focus:var(--slds-g-color-border-accent-2);
    --sds-s-input-color-border-hover:var(--slds-s-input-color-border-hover);
    --slds-s-input-color-border-hover:var(--slds-g-color-border-2);
    ...
    --slds-s-container-color:var(--slds-g-color-on-surface-3);
    --sds-s-container-shadow:var(--slds-s-container-shadow);
    --slds-s-container-shadow:var(--slds-g-shadow-2);
    --sds-s-container-color-border:var(--slds-s-container-color-border);
    --slds-s-container-color-border:var(--slds-g-color-border-1);
    ...
    --slds-s-container-heading-font-size:var(--slds-g-font-scale-2);
    ...
    --slds-s-container-footer-color-background:var(--slds-g-color-surface-container-2);
    --sds-s-container-heading-var-font-size:var(--slds-s-container-heading-var-font-size);
    --slds-s-container-heading-var-font-size:var(--slds-g-font-scale-var-2);
    ...
    --slds-s-button-color-background-hover:var(--slds-g-transparent);
    ...
    --slds-s-button-shadow-focus:0 0 3px var(--sds-g-color-accent-2);
    --sds-s-button-shadow-active:var(--slds-s-button-shadow-active);
    --slds-s-button-shadow-active:0 0 3px var(--sds-g-color-accent-2);
    ...
    --slds-s-button-color-hover:var(--slds-g-color-accent-3);
    ...
    --slds-s-backdrop-color-background:rgba(24, 24, 24, 0.5);
    ...
    --slds-s-alert-font-weight:var(--slds-g-font-weight-4);
  }
}
...
.slds-accordion__list-item{
  border-top-width:var(
    ...
    var(--slds-c-accordion-sizing-border, var(--sds-c-accordion-sizing-border, 1px))
  );
...
.slds-accordion__summary{
  ...
  margin-top:calc(
    var(
        ...
        var(--_slds-c-accordion-section-spacing-block-start-deprecated, 0.75rem)
      ) * -1
  );
  margin-right:calc(
    var(
        --slds-c-accordion-section-spacing-inline-end,
        var(--_slds-c-accordion-section-spacing-inline-end-deprecated, 0.75rem)
      ) * -1
  );
  margin-bottom:calc(
    var(
        --slds-c-accordion-section-spacing-block-end,
        var(--_slds-c-accordion-section-spacing-block-end-deprecated, 0.75rem)
      ) * -1
  );
  margin-left:calc(
    var(
        --slds-c-accordion-section-spacing-inline-start,
        var(--_slds-c-accordion-section-spacing-inline-start-deprecated, 0.75rem)
      ) * -1
  );
  padding-top:var(
    --slds-c-accordion-section-spacing-block-start,
    var(--slds-c-accordion-section-spacing-blockstart, var(--sds-c-accordion-section-spacing-block-start, 0.75rem))
  );
  padding-right:var(
    --slds-c-accordion-section-spacing-inline-end,
    var(--slds-c-accordion-section-spacing-inlineend, var(--sds-c-accordion-section-spacing-inline-end, 0.75rem))
  );
  padding-bottom:var(
    --slds-c-accordion-section-spacing-block-end,
    var(--slds-c-accordion-section-spacing-blockend, var(--sds-c-accordion-section-spacing-block-end, 0.75rem))
  );
  padding-left:var(
    --slds-c-accordion-section-spacing-inline-start,
    var(--slds-c-accordion-section-spacing-inlinestart, var(--sds-c-accordion-section-spacing-inline-start, 0.75rem))
  );
...
.slds-accordion__summary-heading{
  ...
  line-height:var(
    ...
    var(--slds-c-accordion-heading-font-lineheight, var(--sds-c-accordion-heading-line-height, 1.25))
  );
}
...
.slds-accordion__summary-action:focus{
  color:var(--slds-c-accordion-heading-text-color-hover, var(--sds-c-accordion-heading-text-color-hover, #014486));
}
...
.slds-avatar__initials_inverse{
  ...
  --slds-c-avatar-initials-text-color:var(
    --slds-c-avatar-inverse-text-color,
    var(--slds-c-avatar-initials-inverse-text-color, var(--slds-g-color-neutral-base-30, #444444))
  );
...
.slds-avatar__initials_inverse:hover{
  ...
  --slds-c-avatar-initials-text-color-hover:var(
    --slds-c-avatar-inverse-text-color,
    var(--slds-c-avatar-initials-inverse-text-color-hover, var(--slds-g-color-neutral-base-30, #444444))
  );
}
.slds-badge{
  display:-webkit-inline-box;
...
.slds-breadcrumb .slds-breadcrumb__item > a{
  ...
  padding-right:var(
    ...
    var(--slds-c-breadcrumbs-spacing-inlineend, var(--sds-c-breadcrumbs-spacing-inline-end, 0.5rem))
  );
  padding-bottom:0;
  padding-left:var(
    --slds-c-breadcrumbs-spacing-inline-start,
    var(--slds-c-breadcrumbs-spacing-inlinestart, var(--sds-c-breadcrumbs-spacing-inline-start, 0.5rem))
  );
}
...
.slds-button{
  ...
  padding-top:var(
    ...
    var(--slds-c-button-spacing-blockstart, var(--sds-c-button-spacing-block-start, 0))
  );
  padding-right:var(
    --slds-c-button-spacing-inline-end,
    var(--slds-c-button-spacing-inlineend, var(--sds-c-button-spacing-inline-end, 0))
  );
  padding-bottom:var(
    --slds-c-button-spacing-block-end,
    var(--slds-c-button-spacing-blockend, var(--sds-c-button-spacing-block-end, 0))
  );
  padding-left:var(
    --slds-c-button-spacing-inline-start,
    var(--slds-c-button-spacing-inlinestart, var(--sds-c-button-spacing-inline-start, 0))
  );
  background:none;
...
a.slds-button--inverse:focus{
  ...
  --slds-c-button-shadow:var(
    ...
    var(--sds-c-button-inverse-shadow-focus, var(--slds-s-button-shadow-focus-inverse, 0 0 3px #f3f3f3))
  );
  outline:none;
}
.slds-button_reset{
...
.slds-button_neutral{
  ...
  --slds-c-button-spacing-inline-start:var(
    ...
    var(--slds-c-button-neutral-spacing-inlinestart, var(--sds-c-button-neutral-spacing-inline-start, 1rem))
  );
  /*! @css-var-fallback padding-right */
  --slds-c-button-spacing-inline-end:var(
    --slds-c-button-neutral-spacing-inline-end,
    var(--slds-c-button-neutral-spacing-inlineend, var(--sds-c-button-neutral-spacing-inline-end, 1rem))
  );
  text-align:center;
  -webkit-box-pack:center;
  -ms-flex-pack:center;
...
.slds-button_brand{
  ...
  --slds-c-button-spacing-inline-start:var(
    ...
    var(--slds-c-button-brand-spacing-inlinestart, var(--sds-c-button-brand-spacing-inline-start, 1rem))
  );
  /*! @css-var-fallback padding-right */
  --slds-c-button-spacing-inline-end:var(
    --slds-c-button-brand-spacing-inline-end,
    var(--slds-c-button-brand-spacing-inlineend, var(--sds-c-button-brand-spacing-inline-end, 1rem))
  );
  text-align:center;
  -webkit-box-pack:center;
  -ms-flex-pack:center;
...
.slds-button_outline-brand{
  ...
  --slds-c-button-spacing-inline-start:var(
    ...
    var(--slds-c-button-outline-brand-spacing-inlinestart, var(--sds-c-button-outline-brand-spacing-inline-start, 1rem))
  );
  /*! @css-var-fallback padding-right */
  --slds-c-button-spacing-inline-end:var(
    --slds-c-button-outline-brand-spacing-inline-end,
    var(--slds-c-button-outline-brand-spacing-inlineend, var(--sds-c-button-outline-brand-spacing-inline-end, 1rem))
  );
  text-align:center;
  -webkit-box-pack:center;
  -ms-flex-pack:center;
...
.slds-button_outline-brand:active{
  ...
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-active:var(
    --slds-c-button-outline-brand-color-border-active,
...
.slds-button_inverse{
  ...
  --slds-c-button-spacing-inline-start:var(
    ...
    var(--slds-c-button-inverse-spacing-inlinestart, var(--sds-c-button-inverse-spacing-inline-start, 1rem))
  );
  /*! @css-var-fallback padding-right */
  --slds-c-button-spacing-inline-end:var(
    --slds-c-button-inverse-spacing-inline-end,
    var(--slds-c-button-inverse-spacing-inlineend, var(--sds-c-button-inverse-spacing-inline-end, 1rem))
  );
  text-align:center;
  -webkit-box-pack:center;
  -ms-flex-pack:center;
...
.slds-button_destructive{
  ...
  --slds-c-button-spacing-inline-start:var(
    ...
    var(--slds-c-button-destructive-spacing-inlinestart, var(--sds-c-button-destructive-spacing-inline-start, 1rem))
  );
  /*! @css-var-fallback padding-right */
  --slds-c-button-spacing-inline-end:var(
    --slds-c-button-destructive-spacing-inline-end,
    var(--slds-c-button-destructive-spacing-inlineend, var(--sds-c-button-destructive-spacing-inline-end, 1rem))
  );
  text-align:center;
  -webkit-box-pack:center;
  -ms-flex-pack:center;
...
.slds-button_text-destructive{
  ...
  --slds-c-button-spacing-inline-start:var(
    ...
    var(
      --slds-c-button-text-destructive-spacing-inlinestart,
  ...
  --slds-c-button-spacing-inline-end:var(
    ...
    var(
      --slds-c-button-text-destructive-spacing-inlineend,
...
.slds-button_text-destructive:active{
  ...
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-active:var(
    --slds-c-button-text-destructive-color-border-active,
...
.slds-button_success{
  ...
  --slds-c-button-spacing-inline-start:var(
    ...
    var(--slds-c-button-success-spacing-inlinestart, var(--sds-c-button-success-spacing-inline-start, 1rem))
  );
  /*! @css-var-fallback padding-right */
  --slds-c-button-spacing-inline-end:var(
    --slds-c-button-success-spacing-inline-end,
    var(--slds-c-button-success-spacing-inlineend, var(--sds-c-button-success-spacing-inline-end, 1rem))
  );
  text-align:center;
  -webkit-box-pack:center;
  -ms-flex-pack:center;
...
.slds-card{
  ...
  padding-top:var(
    ...
    var(
      --slds-c-card-spacing-blockstart,
      var(--slds-c-card-spacing-block, var(--sds-c-card-spacing-block-start, var(--sds-c-card-spacing-block, 0)))
    )
  );
  padding-right:var(
    --slds-c-card-spacing-inline-end,
    var(
      --slds-c-card-spacing-inlineend,
      var(--slds-c-card-spacing-inline, var(--sds-c-card-spacing-inline-end, var(--sds-c-card-spacing-inline, 0)))
    )
  );
  padding-bottom:var(
    --slds-c-card-spacing-block-end,
    var(
      --slds-c-card-spacing-blockend,
      var(--slds-c-card-spacing-block, var(--sds-c-card-spacing-block-end, var(--sds-c-card-spacing-block, 0)))
    )
  );
  padding-left:var(
    --slds-c-card-spacing-inline-start,
    var(
      --slds-c-card-spacing-inlinestart,
      var(--slds-c-card-spacing-inline, var(--sds-c-card-spacing-inline-start, var(--sds-c-card-spacing-inline, 0)))
    )
  );
  background:var(
...
.slds-card__header{
  ...
  padding-bottom:var(
    ...
    var(
      --slds-c-card-header-spacing-blockend,
      var(
...
.slds-card__body_inner{
  ...
  --slds-c-card-body-spacing-inline-end:var(
    --slds-c-card-body-spacing-inlineend,
    var(--sds-c-card-body-spacing-inline-end, var(--sds-c-card-body-spacing-inline, 1rem))
  );
  /*! @css-var-fallback padding-left */
  --slds-c-card-body-spacing-inline-start:var(
    --slds-c-card-body-spacing-inlinestart,
    var(--sds-c-card-body-spacing-inline-start, var(--sds-c-card-body-spacing-inline, 1rem))
  );
  padding-top:0;
  padding-bottom:0;
}
...
.slds-card__footer{
  ...
  margin-top:var(
    --slds-c-card-footer-spacing-block-start,
    var(--slds-c-card-footer-spacing-blockstart, var(--sds-c-card-footer-spacing-block-start, 0.75rem))
  );
...
.slds-checkbox [type="checkbox"]:checked + .slds-checkbox__label .slds-checkbox_faux:after{
  ...
  border-bottom:2px solid
    var(
      ...
      var(--sds-c-checkbox-mark-color-foreground, var(--slds-s-mark-color-foreground-checked, #0176d3))
    );
  /*! @noflip */
...
.slds-listbox__option .slds-media__body > :first-child{
  display:inline-block;
  vertical-align:middle;
}
...
.slds-listbox__option[aria-disabled="true"]:focus{
  color:var(--slds-c-listbox-option-color-disabled, var(--slds-g-color-neutral-base-50, #c9c9c9));
...
.slds-listbox_vertical .slds-listbox__option:hover{
  background-color:var(--slds-c-listbox-option-color-background-hover, var(--slds-g-color-neutral-base-95, #f3f3f3));
}
.slds-listbox_vertical .slds-listbox__option:focus,
.slds-listbox_vertical .slds-listbox__option.slds-has-focus{
  background-color:var(--slds-c-listbox-option-color-background-focus, var(--slds-g-color-neutral-base-95, #f3f3f3));
  -webkit-box-shadow:var(--slds-g-shadow-inset-focus-1, 0 0 3px #0176d3);
  box-shadow:var(--slds-g-shadow-inset-focus-1, 0 0 3px #0176d3);
  outline:0;
}
...
.slds-listbox__option-meta{
  display:block;
  margin-top:-0.25rem;
  color:var(--slds-c-listbox-option-meta-color, var(--slds-g-color-neutral-base-30, #444444));
}
.slds-listbox__option:hover .slds-listbox__option-meta{
  color:var(--slds-c-listbox-option-meta-color-hover);
}
.slds-listbox__option:focus .slds-listbox__option-meta,
.slds-listbox__option.slds-has-focus .slds-listbox__option-meta{
...
[class*="slds-table_column-"] tr td .slds-truncate:after{
  ...
  background:-webkit-gradient(linear, left top, right top, from(transparent), color-stop(69%, var(--slds-g-color-neutral-base-100, white)));
...
.slds-input{
  padding-top:0;
  padding-right:var(
    --slds-c-input-spacing-inline-end,
    var(--slds-c-input-spacing-horizontal-end, var(--sds-c-input-spacing-horizontal-end, 1rem))
  );
  padding-bottom:0;
  padding-left:var(
    --slds-c-input-spacing-inline-start,
    var(--slds-c-input-spacing-horizontal-start, var(--sds-c-input-spacing-horizontal-start, 0.75rem))
  );
  width:100%;
...
.slds-input-has-icon_left .slds-input_bare{
  /*! @css-var-fallback padding-left */
  --slds-c-input-spacing-inline-start:2rem;
}
...
.slds-input-has-icon_right .slds-input_bare{
  /*! @css-var-fallback padding-right */
  --slds-c-input-spacing-inline-end:2rem;
}
...
.slds-input-has-icon_group-right .slds-input_bare{
  /*! @css-var-fallback padding-right */
  --slds-c-input-spacing-inline-end:calc(3rem + 0.5rem);
}
...
.slds-dropdown{
  ...
  font-size:var(--slds-c-dropdown-font-size, 0.75rem);
  ...
  color:var(--slds-c-dropdown-color, var(--slds-g-color-neutral-base-10, #181818));
}
.slds-dropdown mark{
  font-weight:700;
  background-color:transparent;
...
.slds-dropdown__item > a{
  ...
  color:var(--slds-c-dropdown-item-color, var(--slds-g-color-neutral-base-10, #181818));
  cursor:pointer;
}
...
.slds-dropdown__item > a:hover{
  background-color:var(--slds-c-dropdown-item-color-background-hover, var(--slds-g-color-neutral-base-95, #f3f3f3));
  color:var(--slds-c-dropdown-item-color-hover);
}
.slds-dropdown__item > a:focus{
  background-color:var(--slds-c-dropdown-item-color-background-focus, var(--slds-g-color-neutral-base-95, #f3f3f3));
  -webkit-box-shadow:var(--slds-g-shadow-inset-focus-1, 0 0 3px #0176d3);
  box-shadow:var(--slds-g-shadow-inset-focus-1, 0 0 3px #0176d3);
...
.slds-dropdown__item > a:active{
  text-decoration:none;
  background-color:var(--slds-c-dropdown-item-color-background-active, var(--slds-g-color-neutral-base-95, #f3f3f3));
...
.slds-dropdown__item > a[aria-disabled="true"]:active,
.slds-dropdown__item > a[aria-disabled="true"]:focus{
  ...
  color:var(--slds-c-dropdown-item-color-disabled, var(--slds-g-color-neutral-base-80, #c9c9c9));
}
.slds-dropdown__item > a[aria-disabled="true"]:focus{
  -webkit-box-shadow:none;
  box-shadow:none;
...
[dir="rtl"] .slds-dropdown_left.slds-nubbin_top-left:before,
[dir="rtl"] .slds-dropdown_left.slds-nubbin_top-left:after,
[dir="rtl"] [dir="rtl"] [dir="rtl"] .slds-dropdown_left.slds-nubbin_bottom-left:before,
[dir="rtl"] .slds-dropdown_left.slds-nubbin_bottom-left:after,
[dir="rtl"]
  [dir="rtl"]
  [dir="rtl"]
  [dir="rtl"]
  ...
  [dir="rtl"]
  [dir="rtl"]
  .slds-dropdown--left.slds-nubbin--bottom-left:after{
  /*! @noflip */
  right:1.5rem;
}
.slds-dropdown_right{
...
[dir="rtl"] .slds-dropdown_right.slds-nubbin_top-right:before,
[dir="rtl"] .slds-dropdown_right.slds-nubbin_top-right:after,
[dir="rtl"] [dir="rtl"] [dir="rtl"] .slds-dropdown_right.slds-nubbin_bottom-right:before,
[dir="rtl"] .slds-dropdown_right.slds-nubbin_bottom-right:after,
[dir="rtl"]
  [dir="rtl"]
  [dir="rtl"]
  [dir="rtl"]
  ...
  [dir="rtl"]
  [dir="rtl"]
  .slds-dropdown--right.slds-nubbin--bottom-right:after{
  /*! @noflip */
  right:auto;
  /*! @noflip */
  left:1.5rem;
...
.slds-pill{
  ...
  padding-top:var(
    ...
    var(--slds-c-pill-spacing-blockstart, var(--sds-c-pill-spacing-block-start, 0))
  );
  padding-right:var(
    --slds-c-pill-spacing-inline-end,
    var(--slds-c-pill-spacing-inlineend, var(--sds-c-pill-spacing-inline-end, 0))
  );
  padding-bottom:var(
    --slds-c-pill-spacing-block-end,
    var(--slds-c-pill-spacing-blockend, var(--sds-c-pill-spacing-block-end, 0))
  );
  padding-left:var(
    --slds-c-pill-spacing-inline-start,
    var(--slds-c-pill-spacing-inlinestart, var(--sds-c-pill-spacing-inline-start, 0.125rem))
  );
...
.slds-pill:hover{
  ...
  --slds-c-pill-color-background:var(
    ...
    var(--sds-c-pill-color-background-hover, var(--slds-g-color-neutral-base-95, #f3f3f3))
  );
}
.slds-pill:focus{
  /*! @css-var-fallback box-shadow */
  --slds-c-pill-shadow:var(
    ...
    var(--sds-c-pill-shadow-focus, var(--slds-g-shadow-outline-focus-1, 0 0 3px #0176d3))
  );
  outline:0;
}
.slds-pill a{
...
.slds-pill_container{
  ...
  padding-top:var(
    ...
    var(--slds-c-pill-container-spacing-blockstart, var(--sds-c-pill-container-spacing-block-start, 0.125rem))
  );
  padding-right:var(
    --slds-c-pill-container-spacing-inline-end,
    var(--slds-c-pill-container-spacing-inlineend, var(--sds-c-pill-container-spacing-inline-end, 0.125rem))
  );
  padding-bottom:var(
    --slds-c-pill-container-spacing-block-end,
    var(--slds-c-pill-container-spacing-blockend, var(--sds-c-pill-container-spacing-block-end, 0.125rem))
  );
  padding-left:var(
    --slds-c-pill-container-spacing-inline-start,
    var(--slds-c-pill-container-spacing-inlinestart, var(--sds-c-pill-container-spacing-inline-start, 0.125rem))
  );
  border-width:var(--slds-c-pill-sizing-border, var(--sds-c-pill-sizing-border, 1px));
  border-style:solid;
  border-color:var(
...
.slds-pill__action{
  ...
  --_slds-postcss-fix-calc-part-2:var(--sds-c-pill-spacing-inline-end, 0.125rem);
  padding-right:calc(1rem + var(--_slds-postcss-fix-calc-part-1, var(--_slds-postcss-fix-calc-part-2)) + 6px);
  padding-top:var(
    --slds-c-pill-spacing-block-start,
    var(--slds-c-pill-spacing-blockstart, var(--sds-c-pill-spacing-block-start, 0.125rem))
  );
  padding-bottom:var(
    --slds-c-pill-spacing-block-end,
    var(--slds-c-pill-spacing-blockend, var(--sds-c-pill-spacing-block-end, 0.125rem))
  );
  padding-left:var(
    --slds-c-pill-spacing-inline-start,
    var(--slds-c-pill-spacing-inlinestart, var(--sds-c-pill-spacing-inline-start, 0.125rem))
...
.slds-pill__action:focus{
  -webkit-box-shadow:var(
    ...
    var(--sds-c-pill-action-shadow, var(--slds-g-shadow-outline-focus-1, 0 0 3px #0176d3))
  );
  box-shadow:var(
    --slds-c-pill-action-shadow,
    var(--sds-c-pill-action-shadow, var(--slds-g-shadow-outline-focus-1, 0 0 3px #0176d3))
...
.slds-has-error .slds-pill__label{
  ...
  color:var(
    ...
    var(--slds-c-pill-text-color-error, var(--sds-c-pill-error-text-color, var(--slds-g-color-error-base-40, #ea001e)))
  );
}
...
.slds-radio [type="radio"]:checked + .slds-radio__label .slds-radio_faux:after{
  ...
  background-color:var(
    ...
    var(--sds-c-radio-mark-color-foreground, var(--slds-s-mark-color-foreground-checked, #0176d3))
  );
}
...
.slds-tabs_default__item{
  ...
  padding-top:var(
    ...
    var(
      --slds-c-tabs-item-spacing-blockstart,
      var(
        --slds-c-tabs-item-spacing-block,
  ...
  padding-right:var(
    ...
    var(
      --slds-c-tabs-item-spacing-inlineend,
      var(
        --slds-c-tabs-item-spacing-inline,
  ...
  padding-bottom:var(
    ...
    var(
      --slds-c-tabs-item-spacing-blockend,
      var(
        --slds-c-tabs-item-spacing-block,
  ...
  padding-left:var(
    ...
    var(
      --slds-c-tabs-item-spacing-inlinestart,
      var(
        --slds-c-tabs-item-spacing-inline,
...
.slds-tabs--default__item:has(:focus-visible){
  outline:2px solid var(--slds-g-color-brand-base-40, #0b5cab);
...
.slds-tabs_default__content{
  ...
  padding-top:var(
    ...
    var(
      --slds-c-tabs-panel-spacing-blockstart,
      var(
  ...
  padding-right:var(
    ...
    var(
      --slds-c-tabs-panel-spacing-inlineend,
      var(
  ...
  padding-bottom:var(
    ...
    var(
      --slds-c-tabs-panel-spacing-blockend,
      var(
  ...
  padding-left:var(
    ...
    var(
      --slds-c-tabs-panel-spacing-inlinestart,
      var(
...
.slds-textarea{
  ...
  min-height:var(
    ...
    var(--slds-c-textarea-sizing-height-min, var(--sds-c-textarea-sizing-min-height))
  );
  width:100%;
  padding-top:var(
    --slds-c-textarea-spacing-block-start,
    var(--slds-c-textarea-spacing-blockstart, var(--sds-c-textarea-spacing-block-start, 0.5rem))
  );
  padding-right:var(
    --slds-c-textarea-spacing-inline-end,
    var(--slds-c-textarea-spacing-inlineend, var(--sds-c-textarea-spacing-inline-end, 0.75rem))
  );
  padding-bottom:var(
    --slds-c-textarea-spacing-block-end,
    var(--slds-c-textarea-spacing-blockend, var(--sds-c-textarea-spacing-block-end, 0.5rem))
  );
  padding-left:var(
    --slds-c-textarea-spacing-inline-start,
    var(--slds-c-textarea-spacing-inlinestart, var(--sds-c-textarea-spacing-inline-start, 0.75rem))
  );
  background-color:var(
...
.slds-textarea:active{
  ...
  border-color:var(
    ...
    var(
      ...
      var(--slds-s-input-color-border-focus, var(--slds-g-color-brand-base-60, #1b96ff))
    )
  );
...
.slds-textarea:focus{
  border-color:var(--slds-s-input-color-border-focus, var(--slds-g-color-border-base-4, #c9c9c9));
...
.slds-nav-vertical__item.slds-is-active .slds-nav-vertical__action:focus{
  ...
  -webkit-box-shadow:inset 4px 0 0 #1b96ff;
  box-shadow:inset 4px 0 0 #1b96ff;
  outline:2px solid var(--slds-g-color-palette-blue-40, #0b5cab);
  outline-offset:1px;
}
...
.slds-has-list-interactions > .slds-item.slds-is-selected:focus{
  -webkit-box-shadow:var(--slds-g-color-border-brand-2, #1b96ff) 0 -2px 0 inset,
    var(--slds-g-color-border-brand-2, #1b96ff) 0 0 0 1px inset;
  box-shadow:var(--slds-g-color-border-brand-2, #1b96ff) 0 -2px 0 inset,
    var(--slds-g-color-border-brand-2, #1b96ff) 0 0 0 1px inset;
}
...
.slds-theme_warning button:has(.slds-button__icon)button:has(.slds-button__icon){
  color:var(--slds-g-color-neutral-base-30, #514f4d);
  text-decoration:underline;
}
